...
type Message struct {
	...
	DecryptedVote         []*DecryptedVote       `protobuf:"bytes,14,rep,name=DecryptedVote" json:"DecryptedVote,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
var file_Neonize_proto_rawDesc = string([]byte{
	...
	0x74, 0x65, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6e, 0x65, 0x6f, 0x6e, 0x69,

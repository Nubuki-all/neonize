...
from ..utils.sticker import (
    aio_add_exif_to_sticker,
    aio_convert_to_sticker,
    aio_convert_to_webp,
)
...
class NewAClient:
    ...
    def _make_quoted_message(
        ...
        if jid_is_lid(sender):
            ...
            sender = senderalt if not senderalt.IsEmpty else sender
        return ContextInfo(
    ...
    async def download_any(
        self, message: Message, path: str | None = None
    ) -> None | bytes:
